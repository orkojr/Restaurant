               ...
               <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form enctype="multipart/form-data" method="POST" action="{{ route('admin.menus.update', $menu->id) }}">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="file" id="image" value="{{ $menu->image}}" name="image" class="block p-4 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 ">
                            </div>
                        </div>
                        <div class="sm:col-span-6">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                ...
                                <textarea  id="description" name="description" class="border-gray-300 shadow-sm focus:ring-indigo-500 appearance-none bg-white border rounded-lg py-2 px-3 text-base leading-normal w-full" placeholder="Leave a comment...">
                                    {{ $menu->description}}
                                </textarea>
                        ...
                        <div class="sm:col-span-6">
                            <label for="body" class="block mb-2 text-sm font-medium  text-gray-700 dark:text-gray-300">Categories</label>
                            <div class="mt-1">
                                <select multiple class=" form-multiselect block w-full mt-1 border border-gray-300 " name="categories[]">
